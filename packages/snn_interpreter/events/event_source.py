...
The loader itself lives in :mod:`snn_interpreter.data.event_loader`; this
...
generators in :mod:`snn_interpreter.events.synthetic` only for the offline
...
from snn_interpreter.data.datasets import dataset_available, dataset_info
from snn_interpreter.events import synthetic
