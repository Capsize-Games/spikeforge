...
other op raises :class:`~snn_interpreter.onnx_bridge.errors.
UnsupportedOnnxOpError` naming it — a partial import is never returned.
"""

from typing import Any, Callable, Dict, List, Optional, Tuple

from snn_interpreter.onnx_bridge import api, metadata
from snn_interpreter.onnx_bridge.errors import UnsupportedOnnxOpError
