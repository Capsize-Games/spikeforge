...
from snn_interpreter.targets.backends import api, lowering
from snn_interpreter.targets.backends.errors import BackendUnavailableError
...
DEVICE_NOTE = "ran on the Loihi 2 device opted in via SNN_LAVA_DEVICE"
