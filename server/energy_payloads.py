...
The report reuses :func:`spikeforge_targets.energy.accounting.account_spikes`,
so the socket surface matches the ``spikeforge-energy`` CLI exactly. A
dense-vs-sparse comparison is attached because the parity check is
