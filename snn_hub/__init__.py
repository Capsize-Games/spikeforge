...
from snn_hub.download_cli import download_entry
...
from snn_hub.import_model import import_model as _run_import
...
def download(entry_id: str, dest: Optional[str] = None) -> Dict[str, Any]:
    ...
    The async :class:`~snn_hub.downloads.HubDownloadManager` runs
