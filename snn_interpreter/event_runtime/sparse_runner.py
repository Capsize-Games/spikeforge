...
topology as :func:`~snn_interpreter.simulator.runner.run` but multiplies only
...
from snn_interpreter.event_runtime.counters import SynapticCounter
from snn_interpreter.event_runtime.sparse_result import SparseResult
from snn_interpreter.event_runtime.sparse_step import SparseStageModule
from snn_interpreter.event_runtime.spike_view import SparseSpikes
from snn_interpreter.simulator.frames import normalise_frame
from snn_interpreter.simulator.module_spec import spec_of
from snn_interpreter.simulator.state import initial_state
