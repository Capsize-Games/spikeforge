...
``snn_interpreter.observability.metrics`` exposes one shared
:class:`~snn_interpreter.observability.registry.MetricsRegistry` so callers
...
from snn_interpreter.observability.timer import Timer
