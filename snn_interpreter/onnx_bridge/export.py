...
The declared :class:`~snn_interpreter.topology.spec.TopologySpec` is rendered
...
from snn_interpreter.onnx_bridge import api, metadata, step_module
from snn_interpreter.onnx_bridge.errors import OnnxExportError
