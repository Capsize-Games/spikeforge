...
from snn_targets.capability_matrix import (
    classify,
    classify_by_name,
    compare_targets,
)
from snn_targets.matrix_result import CapabilityMatrix
from snn_targets.primitives import EMITTED_PRIMITIVES
from snn_targets.registry import (
    available,
    available_names,
    get_target,
    target_names,
...
from snn_targets.substitution import Substitution
from snn_targets.summary import target_summaries, target_summary
from snn_targets.target_spec import TargetKind, TargetSpec
