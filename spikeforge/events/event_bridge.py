...
the dense accumulation lives in :mod:`spikeforge.events.dense`, the
...
from spikeforge.introspection.sparsity import sparsity
from spikeforge.simulator.input_shape import (
    SAMPLE_CHANNELS,
    is_spatial,
    to_input_shape,
)
...
class EventSpikeBridge:
    ...
    :func:`~spikeforge.events.dense.to_frames` and ``count`` the raw
    spike-count voxel from :func:`~spikeforge.events.dense.to_voxel`.
